...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: photos.clientsOutdoors, alt: "QLand clients outside their new home" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "About Us · QLand Property",
    description: SOCIAL_DESCRIPTION,
    images: [photos.clientsOutdoors],
  },
};

/** `AboutPage` is the type Google reads for "who is QLand Property" queries. */
const graph = pageGraph({
  path: "/about",
  name: "About QLand Property",
  description: DESCRIPTION,
  type: "AboutPage",
