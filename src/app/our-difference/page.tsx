...
import { inclusionsNode, pageGraph } from "@/lib/schema";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: photos.facadeWhiteDusk, alt: "A rendered QLand facade at dusk" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Our Difference · QLand Property",
    description: SOCIAL_DESCRIPTION,
    images: [photos.facadeWhiteDusk],
  },
};

/** The inclusions list is the answerable part of this page, so it is emitted
    as an `ItemList` rather than left as prose in a grid. */
const graph = pageGraph({
  path: "/our-difference",
  name: ourDifference.title,
  description: DESCRIPTION,
  image: photos.facadeWhiteDusk,
  trail: [{ name: "Our Difference", path: "/our-difference" }],
  extra: [inclusionsNode],
});
