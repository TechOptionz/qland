...
import { buyersAgencyCatalog, pageGraph, serviceId, serviceNode } from "@/lib/schema";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: photos.soldSign, alt: "A sold sign outside a Brisbane property" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Buyers Agency · QLand Property",
    description: SOCIAL_DESCRIPTION,
    images: [photos.soldSign],
  },
};

/** The eight reasons become an offer catalogue on the service, which is what an
    answer engine reaches for on "why use a buyers agent in Brisbane". */
const service = serviceNode({
  path: "/buyers-agency",
  name: "Buyers Agency",
  description: buyersAgency.lede,
  serviceType: "Buyers agent",
  catalog: buyersAgencyCatalog,
});

const graph = pageGraph({
  path: "/buyers-agency",
  name: buyersAgency.title,
  description: DESCRIPTION,
  image: photos.soldSign,
  trail: [{ name: "Buyers Agency", path: "/buyers-agency" }],
  mainEntityId: serviceId("/buyers-agency"),
  extra: [service],
});
