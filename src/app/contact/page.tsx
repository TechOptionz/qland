...
import { contactPlaceNode, pageGraph } from "@/lib/schema";
import { contacts, photos, site } from "@/lib/site";

const DESCRIPTION = `Call ${site.phone}, email ${site.email}, or visit us at ${site.address.line1}, ${site.address.line2}, Eight Mile Plains QLD.`;
...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: "Contact Us · QLand Property",
    description: SOCIAL_DESCRIPTION,
    images: [photos.facadeEvening],
  },
};

/**
 * `ContactPage` plus a `LocalBusiness` for the office itself. This is the pair
 * Google and the AI surfaces read for "QLand Property phone number / address /
 * opening hours" style questions.
 */
const graph = pageGraph({
  path: "/contact",
  name: "Contact QLand Property",
  description: DESCRIPTION,
  type: "ContactPage",
  image: photos.facadeEvening,
  trail: [{ name: "Contact Us", path: "/contact" }],
  extra: [contactPlaceNode],
});
