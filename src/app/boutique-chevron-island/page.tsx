...
import { boutiqueId, boutiqueNode, pageGraph } from "@/lib/schema";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: boutique.images.aerialTower,
        alt: "Aerial render of the BOUTIQUE tower on Chevron Island",
      },
    ],
  },
  twitter: {
    ...
    title: "Boutique Chevron Island · Gold Coast",
    description: SOCIAL_DESCRIPTION,
    images: [boutique.images.aerialTower],
  },
};

/**
 * The development is the page's `mainEntity`, with the amenity list, the unit
 * count, the address, and the "from $1,220,000" starting price all machine
 * readable — that price is the single fact most likely to be asked for.
 */
const graph = pageGraph({
  path: "/boutique-chevron-island",
  name: "BOUTIQUE Chevron Island",
  description: DESCRIPTION,
  image: boutique.images.aerialTower,
  trail: [{ name: "Boutique Chevron Island", path: "/boutique-chevron-island" }],
  mainEntityId: boutiqueId,
  extra: [boutiqueNode],
});
