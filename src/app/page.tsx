...
const TITLE = "QLand Property · Buyer Centric Agency in Brisbane";
const DESCRIPTION =
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: welcomeImage, alt: "A completed QLand home at dusk" }],
  },
  twitter: {
...
/**
 * The home page is the site's entity page: its `mainEntity` is the business
 * itself, which is what ties the organisation node (services, reviews, service
 * area, contacts) to the canonical URL.
 */
